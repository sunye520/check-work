...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet" xmlns:o="urn:schemas-microsoft-com:office:office"
    ...
    <DocumentProperties xmlns="urn:schemas-microsoft-com:office:office">
        ...
        <Created>2018-11-14T01:15:00Z</Created>
        <LastSaved>2018-12-17T04:35:09Z</LastSaved>
    </DocumentProperties>
    <CustomDocumentProperties xmlns="urn:schemas-microsoft-com:office:office">
        <KSOProductBuildVer dt:dt="string">2052-10.1.0.7698</KSOProductBuildVer>
        <KSORubyTemplateID dt:dt="string">11</KSORubyTemplateID>
        ...
        <Style ss:ID="s52">
            ...
            <Borders>
             <Border ss:Position="Bottom" ss:LineStyle="Continuous" ss:Weight="1"/>
              ...
              <Font ss:FontName="宋体" x:CharSet="134" ss:Size="20" ss:Color="#000000" ss:Bold="1"/>
        </Style>
        <Style ss:ID="s53">
            <Alignment ss:Horizontal="Center"/>
            <Borders>
    ...
    <Worksheet ss:Name="201811">
        <Table ss:ExpandedColumnCount="15" ss:ExpandedRowCount="${listDepartment?size+listTechnology?size+10}" x:FullColumns="1" x:FullRows="1" ss:StyleID="s51"
            ...
            <Column ss:StyleID="s51" ss:AutoFitWidth="0" ss:Width="56.25"/>
            <Column ss:StyleID="s51" ss:AutoFitWidth="0" ss:Width="69"/>
            <Column ss:StyleID="s51" ss:AutoFitWidth="0" ss:Width="32.25" ss:Span="5"/>
            <Column ss:Index="11" ss:StyleID="s51" ss:AutoFitWidth="0" ss:Width="81.35"/>
            <Column ss:StyleID="s51" ss:AutoFitWidth="0" ss:Width="194.25"/>
            ...
            <Row ss:Height="25.2">
                <Cell ss:StyleID="s73" ss:MergeDown="2">
                    <Data ss:Type="String">部门</Data>
                </Cell>
                <Cell ss:StyleID="s74" ss:MergeDown="2">
                    <Data ss:Type="String">岗位</Data>
                </Cell>
                <Cell ss:StyleID="s75" ss:MergeDown="2">
                    <Data ss:Type="String">本月人数</Data>
                </Cell>
                <Cell ss:StyleID="s76" ss:MergeDown="2">
                    <Data ss:Type="String">上月末人数</Data>
                </Cell>
                <Cell ss:StyleID="s69" ss:MergeAcross="5">
                    <Data ss:Type="String">本月异动情况</Data>
                </Cell>
                <Cell ss:StyleID="s64"/>
                <Cell ss:StyleID="s82" ss:MergeDown="2">
            ...
            <Row ss:Height="18">
                <Cell ss:Index="5" ss:StyleID="s77" ss:MergeDown="1">
                    <Data ss:Type="String">入职</Data>
                </Cell>
                <Cell ss:StyleID="s70" ss:MergeAcross="1">
                    <Data ss:Type="String">离职</Data>
                </Cell>
                <Cell ss:StyleID="s78" ss:MergeDown="1">
                    <Data ss:Type="String">转正</Data>
                </Cell>
                <Cell ss:StyleID="s79" ss:MergeDown="1">
                    <Data ss:Type="String">调岗</Data>
                </Cell>
                <Cell ss:StyleID="s80" ss:MergeDown="1">
                    <Data ss:Type="String">调薪</Data>
                </Cell>
                <Cell ss:StyleID="s81" ss:MergeDown="1">
                    <Data ss:Type="String">执行时间</Data>
                </Cell>
                <Cell ss:Index="13" ss:StyleID="s63"/>
                <Cell ss:StyleID="s63"/>
                <Cell ss:StyleID="s63"/>
            </Row>
            <Row ss:Height="17.4">
                <Cell ss:Index="6" ss:StyleID="s53">
                    <Data ss:Type="String">主动</Data>
                </Cell>
                <Cell ss:StyleID="s53">
                    <Data ss:Type="String">被动</Data>
                </Cell>
                <Cell ss:Index="13" ss:StyleID="s63"/>
                <Cell ss:StyleID="s63"/>
                <Cell ss:StyleID="s63"/>
            ...
            <#if listDepartment?? >
                <#list listDepartment as changeresult>
                    <Row ss:Height="18.5">
                        <Cell ss:StyleID="s57">
                            <Data ss:Type="String">${changeresult.bumen?if_exists}</Data>
                        </Cell>
                        <Cell ss:StyleID="s57"></Cell>
                        <Cell ss:StyleID="s58">
                            <Data ss:Type="String">${changeresult.benyueRenshu?if_exists}</Data>
                        </Cell>
                        <Cell ss:StyleID="s58">
                            <Data ss:Type="String">${changeresult.shangyuemoRenshu?if_exists}</Data>
                        </Cell>
                        <Cell ss:StyleID="s58">
                            <Data ss:Type="String">${changeresult.ruzhi?if_exists}</Data>
                        </Cell>
                        <Cell ss:StyleID="s58">
                            <Data ss:Type="String">${changeresult.lizhiZhudong?if_exists}</Data>
                        </Cell>
                        <Cell ss:StyleID="s58">
                            <Data ss:Type="String">${changeresult.lizhiBeidong?if_exists}</Data>
                        </Cell>
                        <Cell ss:StyleID="s58">
                            <Data ss:Type="String">${changeresult.zhuanzheng?if_exists}</Data>
                        </Cell>
                        <Cell ss:StyleID="s58">
                            <Data ss:Type="String">${changeresult.tiaogang?if_exists}</Data>
                        </Cell>
                        <Cell ss:StyleID="s58">
                            <Data ss:Type="String">${changeresult.tiaoxin?if_exists}</Data>
                        </Cell>
                        <Cell ss:StyleID="s66"></Cell>
                        <Cell ss:StyleID="s66">
                            <Data ss:Type="String">${changeresult.beizhu?if_exists}</Data>
                        </Cell>
            ...
            <#if listTechnology?? >
                <#list listTechnology as checkchangeresult>
                        <Row ss:Height="18.5">
                            ...
                            <Cell ss:StyleID="s58">
                                <Data ss:Type="String">${checkchangeresult.benyueRenshu?if_exists}</Data>
                            </Cell>
                            <Cell ss:StyleID="s58">
                                <Data ss:Type="String">${checkchangeresult.shangyuemoRenshu?if_exists}</Data>
                            </Cell>
                            <Cell ss:StyleID="s58">
                                <Data ss:Type="String">${checkchangeresult.ruzhi?if_exists}</Data>
                            </Cell>
                            <Cell ss:StyleID="s58">
                                <Data ss:Type="String">${checkchangeresult.lizhiZhudong?if_exists}</Data>
                            </Cell>
                            <Cell ss:StyleID="s58">
                                <Data ss:Type="String">${checkchangeresult.lizhiBeidong?if_exists}</Data>
                            </Cell>
                            <Cell ss:StyleID="s58">
                                <Data ss:Type="String">${checkchangeresult.zhuanzheng?if_exists}</Data>
                            </Cell>
                            <Cell ss:StyleID="s58">
                                <Data ss:Type="String">${checkchangeresult.tiaogang?if_exists}</Data>
                            </Cell>
                            <Cell ss:StyleID="s58">
                                <Data ss:Type="String">${checkchangeresult.tiaoxin?if_exists}</Data>
                            </Cell>
                            <Cell ss:StyleID="s67">

                            </Cell>
                            <Cell ss:StyleID="s67">
                                <Data ss:Type="String">${checkchangeresult.beizhu?if_exists}</Data>
                            </Cell>
                        </Row>
                </#list>
            </#if>
            <#if listCount?? >
                <#list listCount as count>
                        <Row ss:Height="21.6">
                            <Cell ss:StyleID="s71" ss:MergeAcross="1">
                                <Data ss:Type="String">合计</Data>
                            </Cell>
                            <Cell ss:StyleID="s58">
                                <Data ss:Type="String">${count.benyueRenshu?if_exists}</Data>
                            </Cell>
                            <Cell ss:StyleID="s58">
                                <Data ss:Type="String">${count.shangyuemoRenshu?if_exists}</Data>
                            </Cell>
                            <Cell ss:StyleID="s58">
                                <Data ss:Type="String">${count.ruzhi?if_exists}</Data>
                            </Cell>
                            <Cell ss:StyleID="s58">
                                <Data ss:Type="String">${count.lizhiZhudong?if_exists}</Data>
                            </Cell>
                            <Cell ss:StyleID="s58">
                                <Data ss:Type="String">${count.lizhiBeidong?if_exists}</Data>
                            </Cell>
                            <Cell ss:StyleID="s58">
                                <Data ss:Type="String">${count.zhuanzheng?if_exists}</Data>
                            </Cell>
                            <Cell ss:StyleID="s58">
                                <Data ss:Type="String">${count.tiaogang?if_exists}</Data>
                            </Cell>
                            <Cell ss:StyleID="s58">
                                <Data ss:Type="String">${count.tiaoxin?if_exists}</Data>
                            </Cell>
                            <Cell ss:StyleID="s67"/>
                            <Cell ss:StyleID="s67"/>
                        </Row>
            ...
            <Row ss:Height="27">
                <Cell ss:StyleID="s72" ss:MergeAcross="11">
                    <Data ss:Type="String">             人力资源部：                  总裁办：                    总经理：</Data>
                </Cell>
            </Row>
        </Table>
        <WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">
            ...
            <Panes>
                <Pane>
                    ...
                    <RangeSelection>R7C10</RangeSelection>
                </Pane>
            </Panes>
